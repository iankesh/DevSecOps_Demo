    ...
    stages 
    {
        ...
        stage ('Upload Reports to Defect Dojo') 
        {
		    steps 
            {
                ...
                sh 'python upload-results.py --host localhost --api_key 28228a0cba3731814a31f53cd09151dba624a1ef --engagement_id 4 --result_file trufflehog --username admin --scanner "SSL Labs Scan"'
