    ...
    stages 
    {
        ...
        stage ('Upload Reports to Defect Dojo') 
        {
		    steps 
            {
                ...
                sh 'python upload-results.py --host 52.174.83.134:8081 --api_key 28228a0cba3731814a31f53cd09151dba624a1ef --engagement_id 4 --result_file trufflehog --username admin --scanner "SSL Labs Scan"'
                sh 'python upload-results.py --host 52.174.83.134:8081 --api_key 28228a0cba3731814a31f53cd09151dba624a1ef --engagement_id 4 --result_file /var/lib/jenkins/OWASP-Dependency-Check/reports/dependency-check-report.xml --username admin --scanner "Dependency Check Scan"'
                sh 'python upload-results.py --host 52.174.83.134:8081 --api_key 28228a0cba3731814a31f53cd09151dba624a1ef --engagement_id 4 --result_file nmap --username admin --scanner "Nmap Scan"'
                sh 'python upload-results.py --host 52.174.83.134:8081 --api_key 28228a0cba3731814a31f53cd09151dba624a1ef --engagement_id 4 --result_file sslyze-output.json --username admin --scanner "SSL Labs Scan"'
                sh 'python upload-results.py --host 52.174.83.134:8081 --api_key 28228a0cba3731814a31f53cd09151dba624a1ef --engagement_id 4 --result_file nikto-output.xml --username admin' 
		    }
	    }
